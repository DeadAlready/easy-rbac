    ...
    if(Array.isArray(role)) {
        ...
        promise = Q.Promise(function(resolve, reject) {
          ...
          if (typeof role !== 'string') {
              throw new TypeError('Expected first parameter to be string | Array<String>: role');
          }
          ...
          if (!$role.can[operation]) {
              ...
              return Q.any($role.inherits.map(function (parent) {
                  ...
                  .catch(function (err) {
                      if(err.message
                        && err.message.indexOf("an't get fulfillment value from any promise, all promises were rejected.") !== -1) {
